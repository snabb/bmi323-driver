use bmi323_driver::{
    ...
    InterruptPinConfig, InterruptRoute, InterruptSource, MotionAxes, NoMotionConfig,
    OutputDataRate, OutputMode, ReferenceUpdate, I2C_ADDRESS_PRIMARY,
};
...
#[allow(dead_code)]
async fn embassy_style_no_motion_task<I2C, INT, D>(
    i2c: I2C,
    int1: &mut INT,
    delay: &mut D,
