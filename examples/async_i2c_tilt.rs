use bmi323_driver::{
    AccelConfig, ActiveLevel, Bmi323, EventReportMode, InterruptChannel, InterruptPinConfig,
    InterruptRoute, InterruptSource, OutputDataRate, OutputMode, TiltConfig, I2C_ADDRESS_PRIMARY,
};
