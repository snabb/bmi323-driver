...
use bmi323_driver::{
    AccelConfig, ActiveLevel, Bmi323, FeatureBlockingMode, InterruptChannel, InterruptPinConfig,
    InterruptRoute, InterruptSource, OrientationConfig, OrientationMode, OutputDataRate,
    OutputMode, I2C_ADDRESS_PRIMARY,
};
